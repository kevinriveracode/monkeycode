...
export default function ViewPackBasic(props) {
  ...
  const infoPage = {
    image:
      "https://monkeycode.s3.eu-west-3.amazonaws.com/packvenecia.svg",
    title: "PACK DE DISEÑO WEB VENECIA",
    price: "1300 €",
    description:
        ...
        <Grid.Column computer="8" tablet={8} mobile={16}>
          ...
          <section className="checkout-resume">
            <div className="checkout-resume__item">
              <p><span><Image src="https://monkeycode.s3.eu-west-3.amazonaws.com/web-shop.svg" /></span>Diseño web: PACK VENECIA</p>
