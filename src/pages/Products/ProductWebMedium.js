...
function Checkout(props){ 
  ...
  async function handlerBuyTransfer(ev) {
    ...
    let info;
    const url = "http://localhost:3000/buy-pack-ibiza-transfer";
    const urlprod = "https://stagging-startfly.herokuapp.com/buy-pack-ibiza-transfer";
    const response = await fetch(urlprod, {
      method:'POST',
      headers: {
        'Content-Type': 'application/json',
        ...
        <Grid.Column computer="8" tablet={8} mobile={16}>
          ...
          <section className="checkout-resume">
            <div className="checkout-resume__item">
              <p><span><Image src="https://monkeycode.s3.eu-west-3.amazonaws.com/web-shop.svg" /></span>Diseño web: PACK IBIZA</p>
              <span>500 €</span>
            </div>
            <div className="checkout-resume__item">
              <p><b>SUBTOTAL</b></p>
