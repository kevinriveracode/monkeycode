  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://startfly.es/product/diseño-web-pack-mallorca/"></link>
      </Helmet>
      <Header />
        ...
        <Grid.Column computer="8" tablet={8} mobile={16}>
          ...
          <section className="checkout-resume">
            <div className="checkout-resume__item">
              <p><span><Image src="https://monkeycode.s3.eu-west-3.amazonaws.com/web-shop.svg" /></span>Diseño web: PACK MALLORCA</p>
              <span>900 €</span>
            </div>
            <div className="checkout-resume__item">
              <p><b>SUBTOTAL</b></p>
